...
public class JedisCluster extends BinaryJedisCluster implements JedisCommands,
  ...
  public String set(final String key, final String value) {
    return new JedisClusterCommand<String>(connectionHandler, maxRedirections, true) {
      @Override
  ...
  public Long persist(final String key) {
    return new JedisClusterCommand<Long>(connectionHandler, maxRedirections, true) {
      @Override
      public Long execute(Jedis connection) {
  ...
  public Boolean setbit(final String key, final long offset, final boolean value) {
    return new JedisClusterCommand<Boolean>(connectionHandler, maxRedirections, true) {
      @Override
      public Boolean execute(Jedis connection) {
  ...
  public Double incrByFloat(final String key, final double value) {
    return new JedisClusterCommand<Double>(connectionHandler, maxRedirections, true) {
      @Override
  ...
  public Set<String> spop(final String key, final long count) {
    return new JedisClusterCommand<Set<String>>(connectionHandler, maxRedirections, true) {
      @Override
      public Set<String> execute(Jedis connection) {
  ...
  public List<String> sort(final String key) {
    return new JedisClusterCommand<List<String>>(connectionHandler, maxRedirections, true) {
      @Override
      public List<String> execute(Jedis connection) {
  ...
  public List<GeoRadiusResponse> georadius(final String key, final double longitude, final double latitude,
    ...
    return new JedisClusterCommand<List<GeoRadiusResponse>>(connectionHandler, maxRedirections, true) {
      @Override
