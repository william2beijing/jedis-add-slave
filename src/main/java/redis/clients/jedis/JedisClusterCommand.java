...
public abstract class JedisClusterCommand<T> {
  ...
  public JedisClusterCommand(JedisClusterConnectionHandler connectionHandler, int maxRedirections, boolean isWriteCommand) {
	this.connectionHandler = connectionHandler;
	this.redirections = maxRedirections;
    ...
    try {
      ...
      if (asking) {
        ...
        if (tryRandomNode) {
          ...
          connection = connectionHandler.getConnectionFromSlot(JedisClusterCRC16.getSlot(key),isWriteCommand);
        }
      }
